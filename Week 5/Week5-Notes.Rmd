...
- Last week, we have talked about the probability of an event.    
  + **Example**: let `C` be the even that a person is diagnosed with Cancer, we have `P(C)`.
...
```{r, message=FALSE, out.width="80%", echo = FALSE}
xpnorm(3, mean=3.3, sd=0.56)
```
