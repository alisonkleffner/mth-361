...
--
.pull-right[
- **Center**: Average heart rate is 98.925 and half of the people have a heart rate over 96.
- **Variability**: The range of the data is from 39-192, while a typical value would fall between 72.1 and 125.8. Standard deviation of 26.83, says the data is fairly spread out.
- **Shape**: Unimodal and almost symmetrical (slightly skewed right)
- **Outlier**: Maybe at the far right
]
