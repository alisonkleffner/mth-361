...
- Homework 8 (MLR) due Thursday (November 21) at 11:59pm
- Homework 9 (Categorical Data) due Friday December 6 at 11:59pm

Labs:

- Lab 10 due December 2 at 11:59 pm
  + Work Day November 26th

Analysis Plan

- Due November 26 at 11:59 pm
...
We can calculate confidence intervals and carry out hypothesis tests using this approximation but we want to be more accurate.
...
- Calculate the probability of observing a "more extreme" result using this binomial distribution.

Have two "test statistics": # improved patients (`x=21`), and # trials (`n=52`).
...
What's the probability that 21 patients or more improve, __if the true improvement rate is 30%__?
