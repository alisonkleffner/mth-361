...
Formula: $$\bar{x} \pm 1.96 \cdot SE_{\bar{x}} = $$

--

$$ 171.4833 \pm 2(\frac{39.7942}{\sqrt{60}}) = $$
--
...
We are 95% confident that the population mean weight of US adults is in the range of [161.2093, 181.7573]. 
...
$$ P(|\mu - \bar{x}| < 0.5)  = P(\mu - 0.5 < \bar{x} < \mu + 0.5)$$
$$= P(\frac{\mu - 0.5 - \mu}{SE_{\bar{x}}} < \frac{\bar{x} - \mu}{SE_{\bar{x}}} < \frac{\mu + 0.5 + \mu}{SE_{\bar{x}}}$$
$$= P(-\frac{0.5}{8/\sqrt{190}} < Z \frac{0.5}{8/\sqrt{190}} = P(-0.58 < Z < 0.58)$$
$$= 0.7190 - 0.2810 = 0.438$$
---
### Chaning the Confidence Level
...
$$ P(\mu - 0.5 < \bar{x} < \mu + 0.5) = 0.95$$
$$P(\frac{-0.5}{\frac{\sigma}{\sqrt{n}}} < Z \frac{0.5}{\frac{\sigma}{\sqrt{n}}}) = 0.95$$
$$ \frac{0.5\sqrt{n}}{\sigma} = 1.96$$
$$n = (1.96\sigma*2)^2 = (3.92*8)^2 = 983.44$$
We at least need to sample 984 people
