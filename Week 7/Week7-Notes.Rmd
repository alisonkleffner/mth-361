...
Homework 5 **due Tonight at 11:59pm**!

Lab 6 on Thursday (**due Friday at 11:59 pm**)
  + Rock-Paper-Scissors Portion
    - Part of Lab will be completed as a class on Thursday
    - To do so we need to simulate some data
    - Play 12 games of Rock-Papers-Scissors with a friend and count the number of times they chose heads (do not tell them what you are counting).
    - Record your number in the Blueline assignment: Lab 6: Rock-Paper-Scissors **due at 12:30 pm on Thursday September 28** (before class)
    - Completion of this is worth 5 points on your Lab 6 grade.
    
Midterm on Thursday October 5
  - Review on Tuesday October 3

---
### Notes on Lab 5

+ Distribution of Random Variable, X: $X \sim N(\mu, \sigma)$

+ From one sample from the population, we can calculate $\bar{x}$
  - But we don't know if this is a good estimate of $\mu$ or not

+ If we take multiple samples from the population, we will have multiple $\bar{x}$. 
  - This creates a distribution, called the sampling distribution
  - $\bar{x} \sim N(\mu, SE_{\bar{x}})$
  - When using applets, make sure to use $SE_{\bar{x}}$ instead of $\sigma$
  - Less spread out than distribution of X

+ The word "cause" should send up a red flag

+ 95% confidence is not a probability
...
knitr::include_graphics("../images/Week7/pvalue-controversy.png")
```
...
knitr::include_graphics("../images/Week7/pvalue-def.png")
```
...
How to covert test statistics to p-value? Recall what we did to convert the Z-score to a probability.
...
Because the test makes use of the t distribution, it is called T-test. In today’s lecture, we only have one variable and try to decide whether the variable’s mean is higher/lower/equal to an expected value, this is called one sample t-test.

```{r, echo=FALSE, out.width="70%", fig.align='center'}

knitr::include_graphics("../images/Week7/t-distribution.png")
...
knitr::include_graphics("../images/Week7/pvalue-controversy2.png")
...
### Example: Mercury Levels for Saltwater Fish
...
knitr::include_graphics("../images/Week7/error-table.png")
...
knitr::include_graphics("../images/Week7/rg-error.png")
...
Type 1: Conclude anti-depressants are working when they are not (Reject)

--

Type 2: Conclude they are not working when they are (Fail to Reject)
---
...
Type 1: conclude that the aspirin tablet has more than the active ingredient when they do not

Type 2: conclude that aspirin tablets don't have more than the active ingredient when they do
---
...
knitr::include_graphics("../images/Week7/power-table.png")
