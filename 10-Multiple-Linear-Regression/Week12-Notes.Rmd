...
For categorical variables that have two levels, it does not matter if we specify it as categorical or not. What if are variable has more than two levels?
